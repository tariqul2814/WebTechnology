<?php
    ...
    if (mysqli_connect_errno())
    {
        ...
        $sqlPage = "SELECT * FROM pages WHERE is_active=1;";
    ...
    <body>
        <div class="header">
            ...
            <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse ml-auto navigation" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item text-nowrap"><a class="nav-link" href="index.php">Home</a></li>
                        <?php
                            if ($resultPage->num_rows > 0) {
                                foreach ($resultPage as $page) {
                                    ?>
                                    <li class="nav-item text-nowrap"><a class="nav-link" href="page.php?id=<?php echo $page["page_id"]; ?>"><?php echo $page["page_title"]?></a></li>
                                    <?php
                                }
                            }
                        ?>
                        <li class="nav-item text-nowrap" ><a class="nav-link" href="./admin/index.php">Login</a></li>
                        <li class="nav-item text-nowrap"><a class="nav-link" href="javascript:srch();"><i class="fa fa-search"></i></a></li>
                    </ul>
                </div>
            </nav>
